...
exports.seed = async function(knex) {
  ...
  await knex('posts').insert([
    {user_id: 1, title: "baby's first post", content: "hello bloggy world@!@@", creation_date: new Date(2022, 0, 1).toISOString().split("T")[0]},
    {user_id: 2, title: "another post", content: "more content for the masses", creation_date: new Date(2022, 0, 1).toISOString().split("T")[0]},
    {user_id: 2, title: "i love posting!", content: "inundation", creation_date: new Date(2022, 0, 1).toISOString().split("T")[0]},
